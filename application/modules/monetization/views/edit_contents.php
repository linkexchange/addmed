					...
					<div class="panel-body">
						<form class="form-horizontal" id="frm_edit_contents" action="" method="POST">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" class="form-control validate[required,custom[email]]" placeholder="Contact Email"  name="contact_email" id="contact_email" value="<?php echo $contents[0]["contact_email"];?>">
								</div><!-- /.col -->
							</div><!-- /form-group -->
