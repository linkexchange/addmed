	...
	<div class="padding-md">
		<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
			<div class="panel-heading" style="border:1px solid #D6E9F3;background:#fff;">
				<h3><b><i class="icon-globe"></i>  Edit Contents</b> </h3>
			</div>
		</div> <br/>
		<div class="row">
			<div class="col-md-12">
					...
					<div class="panel-body">
						<form class="form-horizontal" id="frm_edit_contents" action="" method="POST">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" class="form-control validate[required,custom[number]]" placeholder="ratings in %"  name="ratings" id="ratings" value="<?php echo $contents[0]["ratings"];?>">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" class="form-control validate[required,custom[number,max[100]]]" placeholder="No of articles"  name="no_of_articles" id="no_of_articles" value="<?php echo $contents[0]["no_of_articles"];?>">
								</div><!-- /.col -->
							</div><!-- /form-group -->
