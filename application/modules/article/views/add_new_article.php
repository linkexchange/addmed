                                    ...
                                    <form class="form-horizontal" id="frm_addNewArticle" action="" method="POST" enctype="multipart/form-data" >
                            			<fieldset>
                                        	<div class="control-group">		
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="validate[required]" placeholder="Article Title" value="" name="articleTopic" id="articleTopic">
                                                    </div> <!-- /controls -->				
											</div> <!-- /control-group -->
											<div class="control-group">											
                                            ...
                                            <div class="control-group">	
                                                <div class="controls">
                                                    ...
                                                    <a href="<?php echo base_url()?>article/dashboard" class="btn">Cancel</a>						
												</div>
                                            </div> <!-- /control-group -->
                                        </fieldset>
                                    </form>
