    ...
    <div class="padding-md">
        <div class="panel panel-default table-responsive">
            <div class="panel-heading">
            	<h3>
                    <b><i class="icon-list-alt"></i> Advertiser's Stats</b>
                </h3>
            </div>
...
<script>
    function getUnPublihsedLinks(page){
        $.ajax({
            url:"<?php echo base_url(); ?>advertiser/dashboard/getUnpublishedurls/"+page,
    ...
    function getPublihsedLinks(page){
        $.ajax({
            url:"<?php echo base_url(); ?>advertiser/dashboard/getPublishedurls/"+page,
                //beforeSend: loadStartPub,
		//complete: loadStopPub,
            success:function(result){
            	//alert(result);
