			...
			<div class="row">
                ...
                <div class="widget"> 
					<div class="span12 offset10"> 
						<button onclick="javascript:goto('template/dashboard/add')" class="btn btn-primary btn-large  icon-anchor"> Add Website</button>
					</div>
				</div>
                                ...
                                if($count>$mod) :
                                    ...
                                    for($i=0;$i<=$count;$i++) :
                                        if(($i%$mod)==0) :
                                            //echo $inc;
                                        ?>
                                        <a class="btn btn-small btn-success page-<?php echo $inc; ?> <?php if($inc==$this->uri->segment(4))  echo "page-active"; else if(!($this->uri->segment(4)) && $inc==1)  echo "page-active";  ?>" href="<?php echo base_url()."template/dashboard/index/".$inc; ?>" ><?php echo $inc; ?></a>
                                            <?php
                                            $inc++;
                                        endif;
                                    endfor;
