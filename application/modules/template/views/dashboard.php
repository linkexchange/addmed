		...
		<?php if($this->session->userdata("userTypeID")==3) : ?>
			<div class="widget pull-right"> 
				<div class="span12 offset10"> 
					<a class="btn btn-success btn-large  icon-anchor" href="<?php echo base_url();?>template/dashboard/add"> Add Website</a>
				</div>
			</div>
		<?php endif; ?><br/> <br/>
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3><b><i class="icon-globe"></i> Websites</b></h3>
			</div>
			<div id="errorMessage" class="alert alert-danger" style="display:none"></div>
			<?php if($this->session->flashdata('message')) { ?>
			<div id="successMessage" class="alert alert-success"><?php echo $this->session->flashdata('message');?></div>
			<?php } ?>
