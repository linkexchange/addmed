                                    ...
                                    <form class="form-horizontal" id="frm_addArticle" action="" method="POST" enctype="multipart/form-data" >
                            			<fieldset>
                                            ...
                                            <div class="setArticleData">
                                            	...
                                            	<div class="control-group">		<label for="articleTitle_<?php echo $i; ?>" class="control-label">Gallery Item Title</label>
                                                    <div class="controls">
                                                ...
                                                <div class="control-group">		<label for="articleDescription_<?php echo $i; ?>" class="control-label">Gallery Item Description</label>
                                                    <div class="controls">
