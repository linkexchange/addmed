...
<script>
	$(document).ready(function(){
		...
		if(tid){
			 $.ajax({
				url:base_url+"admin/blogs/getTemplateBlogs/"+tid+"/"+page,
				...
				<div class="span12">
                	<div class="widget add-blog"> 
                        <div class="span12 offset10"> 
                            <button onclick="javascript:goto('admin/blogs/add')" class="btn btn-primary btn-large  icon-anchor"> Add Post</button>
                        </div><!-- span12 offset10 -->
					</div><!-- widget add-blog -->
                                            ...
                                            <?php  foreach($blogs as $item) : ?>
                                                <tr>
                                                  ...
                                                  <!--  <td><?php echo $item['description']; ?></td>-->
                                                    ...
                                                    <td>
                                                        <a class="btn btn-small btn-success" href="<?php echo base_url()."admin/blogs/edit/".$item['id']; ?>" title="Edit Post : <?php echo $item['title']; ?>">
...
<script>
	function getDetails(lid){
			...
			if(lid){
			 $.ajax({
				url:base_url+"admin/blogs/getTemplateBlogs/"+lid,
				//beforeSend: loadStartPub,
				//complete: loadStopPub,
				success:function(result){
					//alert(result);
