			...
			<div class="row">
				<div class="span12">
                	<div class="span12" style="margin:0px 0px 15px 0px; text-align:right; "> 
                    	<button onclick="javascript:goto('admin/advertisement/add')" class="btn btn-primary btn-large  icon-anchor"> Add Ad</button>
                    </div><!--span12 offset10-->
                                        	...
                                        	<?php foreach ($ads as $ad) : ?>
                                            	<tr>
                                                    ...
                                                    <td class="td-actions">
                                                        ...
                                                        <a class="btn btn-small btn-success" href="<?php echo base_url()."admin/advertisement/edit/".$ad['id']; ?>" title="Edit">
                                                            <i class="btn-icon-only icon-edit"> </i>
                                                        </a>
                                                        <a class="btn btn-danger btn-small" href="<?php echo base_url()."admin/advertisement/delete/".$ad['id']; ?>" title="Delete">
                                            ...
                                            if($count>$mod) :
                                                ...
                                                for($i=0;$i<=$count;$i++) :
                                                    if(($i%$mod)==0) :
                                                        //echo $inc;
                                                    ?>
                                                    <a class="btn btn-small btn-success page-<?php echo $inc; ?> <?php if($inc==$this->uri->segment(4))  echo "page-active"; else if(!($this->uri->segment(4)) && $inc==1)  echo "page-active";  ?>" href="<?php echo base_url()."admin/articles/index/".$inc; ?>" ><?php echo $inc; ?></a>
                                                        <?php
                                                        $inc++;
                                                    endif;
                                                endfor;
