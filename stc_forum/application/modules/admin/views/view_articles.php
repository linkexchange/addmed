			...
			<div class="row">
				<div class="span12">
                	<div class="span12" style="margin:0px 0px 15px 0px; text-align:right; "> 
                    	<button onclick="javascript:goto('admin/forum_article/add')" class="btn btn-primary btn-large  icon-anchor"> Add Article</button>
                    </div>
                	<div class="widget">
                                                        ...
                                                        for($i=0;$i<=$count;$i++) :
                                                            if(($i%$mod)==0) :
                                                                //echo $inc; ?>
                                                            	 ...
                                                            	 <a class="btn btn-small btn-success page-<?php echo $inc;?> <?php if($inc==$this->uri->segment(6))  echo "page-active"; else if(!($this->uri->segment(6)) && $inc==1)  echo "page-active";  ?>" href="<?php echo base_url()."admin/forum_article/index/".$inc; ?>" ><?php echo $inc; ?></a>
...
<script>
	...
	{  
		...
		$.ajax({
            url : base_url+'admin/forum_article/getArticles/'+value,
            type: 'POST',
            data: {submit:true},
